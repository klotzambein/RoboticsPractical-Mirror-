...
int main(int argc, char **argv) {
  ...
  ros::param::param(std::string("~max_x_speed"), max_x_speed_, float(0.2));
  ros::param::param(std::string("~max_theta_speed"), max_theta_speed_, float(0.2));
  ros::param::param(std::string("~speed_step"), speed_step_, float(0.02));
  ros::param::param(std::string("~theta_step"), theta_step_, float(0.05));
